...
def hhvacancy(key):
    ...
    while True:
        ...
        for v in vacancy_list:
            vacancy = {}
            vacancy['name'] = v.find('a', {'class': 'bloko-link HH-LinkModifier'}).getText()
            vacancy['link'] = v.find('a', {'class': 'bloko-link HH-LinkModifier'})['href']
            vacancy['vacancyId'] = int(vacancy['link'][22:30])
        ...
        try:
            ...
            print(f'Всего найдено {lnum} записей c hh.ru')
            break
